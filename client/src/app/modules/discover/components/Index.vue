<template>
  <div>
    ...
    <div v-show="!requestPending" class="text-xs-center">
      ...
      <div v-bind:class="{ 'pagination__subtext--hidden': $vuetify.breakpoint.xsOnly }" class="pagination__subtext">{{ requestsLeft }} requests left for current hour</div>
    </div>
  </div>
</template>
